...
//         <form onSubmit={handleSubmit} className="flex flex-col items-center gap-4 p-4 border rounded-lg shadow-md w-80">
...
//           {errors.otp && touched.otp && <div className="text-red-500 text-sm">{errors.otp}</div>}
